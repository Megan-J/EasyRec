...
public class EditRecommendationController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
		...
		try {
	    	...
	    	firstCourseTitle.getItems().addAll(profileModel.getCourses());
		...
		try {
			...
			ObservableList<String> courses = profileModel.getCourses();
			ObservableList<String> perChars = recMod.getPersonalChars();
			ObservableList<String> acadChars = recMod.getAcademicChars();
